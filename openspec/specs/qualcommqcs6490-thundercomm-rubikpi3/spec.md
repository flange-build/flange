...
## Purpose
定义 Thundercomm RUBIK Pi 3（QCS6490）在 qualcommqcs6490 平台上的板级契约：复用主线 7.0.2 基线的板级目标、上游 DTS 修复 backport、位于 UFS boot LUN 的启动固件清单与单会话 edl-ng 全量刷写、UEFI dtb 分区镜像，以及板载 AP6256 与 Renesas USB3 固件的运行时准备。
## Requirements
