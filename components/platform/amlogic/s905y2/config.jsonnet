// Amlogic S905Y2 SoC 层配置：声明芯片级源码、Kconfig、设备树和固件能力。
// Amlogic S905Y2 (G12A family) SoC 配置 -- SoC overlay
//
...
// 与 s905d3 高度同形。
{
  ...
  sources+: {
    ...
    'amlogic-boot-fip': {
      ...
      // board 层声明 kernel.device_tree.name = "meson-g12a-radxa-zero"。
      url: 'https://github.com/LibreELEC/amlogic-boot-fip.git',
      branch: 'master',
    },
  },
  bootloader+: {
    source: { name: 'u-boot-s905y2' },
