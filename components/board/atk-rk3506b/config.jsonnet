// ATK RK3506B 板级配置：声明设备树、产品条件和板载硬件策略。
...

{
  ...
  flash_identity: {
    chip_patterns: [
      ...
      '\\b(?:46\\s+30\\s+35\\s+33|f053)\\b',
    ],
    storage_patterns: ['\\b(?:spi[ -]?nand|snand)\\b'],
    require_rid: false,
  },
  sources+: {
    rtl8733bu_wifi: {
      ...
      url: 'https://github.com/wirenboard/rtl8733bu.git',
      branch: 'v5.13.0.1-112',
      commit: '2d9048be60759206b8db5e2370420333ef0b8478',
    },
    rtl8733bu_bt: {
      url: 'https://gitee.com/fengyuzhong/rtl8733bu-bt.git',
      branch: 'master',
      commit: 'dc7b30b4b9d2c5437a80bfaff6c8a77c97642778',
    },
  },
  ...
  kernel+: {
    ...
    defconfig: [
      'rk3506_defconfig', 'rk3506-display.config', 'rockchip_amp.config',
      'case_insensitive_fix.config', 'rk3506-wifibt.config',
    ],
    config+: {
      // 对齐 ATK BSP 的 rk3506-ethernet.config，并由后置的
      // flange_overrides.config 覆盖通用 defconfig 中对应的 module 配置。
    ...
    device_tree+: {
      name: 'rk3506b-alientek-mipi720x1280-nand-ubi-ubifs-amp-linux',
    },
    oot_sources: {
      rtl8733bu_wifi: { source: { name: 'rtl8733bu_wifi' } },
      rtl8733bu_bt: { source: { name: 'rtl8733bu_bt' } },
    },
    oot_modules+: [
      {
        ...
        pre_build: [
          ...
          'git -C {rtl8733bu_wifi_src} apply /workspace/components/board/atk-rk3506b/patches/rtl8733bu/0001-disable-removed-regulatory-flag.patch',
        ],
        make_args: [
          'ARCH={arch}', 'CROSS_COMPILE={cross_compile}',
          'KSRC={kernel_src}', 'M={rtl8733bu_wifi_src}',
          'CONFIG_RTW_DEBUG=n', 'CONFIG_PROC_DEBUG=n',
          'USER_EXTRA_CFLAGS=-Wno-unused-function -Wno-discarded-qualifiers',
        ],
        ko_pattern: ['{rtl8733bu_wifi_src}/8733bu.ko'],
      },
      {
        ...
        make_args: [
          '-C', '{kernel_src}',
          'M={rtl8733bu_bt_src}/usb/bluetooth_usb_driver', 'modules',
          'ARCH={arch}', 'CROSS_COMPILE={cross_compile}',
        ],
        ko_pattern: [
          '{rtl8733bu_bt_src}/usb/bluetooth_usb_driver/rtk_btusb.ko',
        ],
      },
    ],
  },
  ...
  amp+: {
    enabled: true,
    mode: 'rt-thread',
    app: if product == 'fluxion' then 'fluxion_runtime'
         else 'rk3506_amp_uart4_rtt_demo',
  },
  ...
  external_apps: if product == 'fluxion' then {
    fluxion_runtime: {
      local_path: '../fluxion/Device/FlangeApps/fluxion_runtime',
    },
  } else {},
  partitions: {
    ...
    entries: [
      ...
      { name: 'recovery', offset: '0x28000', size: '0x800', type: 'ext4' },
      { name: 'amp', offset: '0x28800', size: '0x8000', type: 'ext4' },
      { name: 'rootfs', offset: '0x30800', size: '414M', type: 'ext4' },
    ],
  },
  rootfs+: {
    image_format: 'ubi',
    ...
    packages+: [
      ...
      'bluez', 'alsa-utils', 'evtest', 'libasound2t64',
      'libcurl3t64-gnutls', 'libfreetype6', 'libmpg123-0t64',
      'libqrencode4', 'libssl3t64', 'fonts-wqy-microhei',
    ],
    ...
    extra_firmware+: [{
      ...
      source: {
        name: 'rtl8733bu_bt',
        subpath: 'rtkbt-firmware/lib/firmware',
      },
      files: ['rtl8733bu_fw', 'rtl8733bu_config'],
      dest: 'lib/firmware',
    }],
    ubi: {
