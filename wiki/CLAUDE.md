...
4. **信息保全优先**：整理、合并或拆页不得删除唯一信息；过时内容应标明适用版本或移入历史小节，迁移内容必须留下可追溯链接。不得仅为缩短篇幅而删减验收结果、排障过程、硬件约束或历史结论
...
- **步骤**：
  ...
  3. 列出 5–15 候选页给用户确认
  4. 改写前对照旧页面，确认每条唯一信息是保留、更新还是迁移；迁移时补回链
  5. 改完后检查删除内容的去向，并追加一条 `log.md` 条目
  6. 不擅自改未确认的页
