...
OrangePi 5 Plus，RK3588，项目第二块 RK3588 板。首版落地：eMMC + UART2 + SSH + M.2 E-Key RTL8852BE WiFi/BT，逐字段复用 [[radxa-rock5b]] 模板。第二批：30-pin DSI FPC 接 HX8399-A 1080×1920 portrait 4-lane MIPI DSI 面板 + GT911 5-point 电容触摸（软件落地完成，实机点屏验收 pending）。HDMI / NPU / NVMe / 板载 AP6275P / 双 2.5G NIC 显式配置 / PWM 风扇 / RGB LED 不在范围（RTL8125 走 r8169 主线驱动零配置自动 probe）。
...
| 板私有 dtso | `rk3588-orangepi-5-plus-hx8399a-gt911.dtbo` 默认应用（HX8399-A DSI 屏 + GT911 触摸） |
